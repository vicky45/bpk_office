...
$(".se-pre-con").fadeOut("slow");
    ...
    <script>
        ...
        // ====== javascript Tab Content Summary ====== \\
        ...
        // For Summary Polling (default by Error)
        document.getElementById("defaultOpen").click();
        // ====== javascript Modal Create Polling ====== \\
        function showDiv(id){
        var idv = "form-" + id;
        ...
        // ====== javascript Add Admin in Edit Event ====== \\
        function newElement() {
